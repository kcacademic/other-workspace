...
import com.kchandrakant.learning.client.AdditionService;
import com.kchandrakant.learning.client.MultiplicationService;
...
public class Application {
	...
	private int performAddition(int number) {
		...
		int x = restTemplate.exchange("http://localhost:8081/add/" + number, HttpMethod.GET, entity, Integer.class)
				.getBody();
	...
	private int performAdditionRetrofit(int number) {
	...
	@SuppressWarnings("unused")
	private int performMultiplicationRetrofit(int number) {
